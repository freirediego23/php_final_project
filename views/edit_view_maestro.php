...
<body>
  ...
  <a href="./dash_admin.php">Volver</a>
  <h2>Edita Informacion de Maestros</h2>

  <form action="/update_maestro" method="post">
    <input type="text" hidden name="id" value="<?= $maestros[0]["id"] ?>">
    <label for="">Nombres</label>
    <input type="text" name="nombre" value="<?= $maestros[0]["nombres"] ?>">
    <br>
    <label for="">Email</label>
    <input type="text" name="email" value="<?= $maestros[0]["email"] ?>">
    <br>
    <label for="">Password</label>
    <input type="text" name="password" value="<?= $maestros[0]["passwords"] ?>">
    <br>
